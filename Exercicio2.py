...
caminho = "heart/heart_failure_clinical_records_dataset.csv"
...
train_set =  train_set.drop(columns=['DEATH_EVENT'])
test_set =  test_set.drop(columns=['DEATH_EVENT'])
